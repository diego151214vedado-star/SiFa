-- ============================================================
-- SIFA — Seed de datos reales (backup 2026-04-29) v3
-- ============================================================
...
insert into invoices (id, empresa_id, tipo_key, titulo, fecha, numero, cliente_id, moneda, emisora_key, proveedor, lineas, subtotal, flete, seguro, total, consignatario, condicion, incoterm, origen, puerto, peso, bultos, notas, entregado_por, convertida, factura_generada) values
  ('mo7hlpyyg3h6d3w6bqk', 'az', 'O', 'ORDEN DE ENTREGA', '2026-04-20', '2627', null, 'USD', null, '', '[{"prodId": "mo7gqqctcodzeg04lqm", "nombre": "Muslo de pollo caja 15 kG Sanderson Farms", "codigo": "1079460569189", "um": "Caja", "qty": 40, "price": 30, "importe": 1200}]'::jsonb, 1200, 0, 0, 1200, '', '', '', '', '', '600', '40', '', null, false, null),
  ('mo9ry3u8uofgvj362f', 'az', 'F', 'FACTURA', '2026-04-22', 'F0001', null, 'USD', 'az', '', '[{"prodId": "mo7gqqctcodzeg04lqm", "nombre": "Muslo de pollo caja 15 kG Sanderson Farms", "codigo": "1079460569189", "um": "Caja", "qty": 1, "price": 30, "importe": 30}]'::jsonb, 30, 0, 0, 30, '', '', '', '', '', '', '', '', 'Nelson Pimentel', false, null)
on conflict (id) do nothing;
...
insert into invoices (id, empresa_id, tipo_key, titulo, fecha, numero, cliente_id, moneda, emisora_key, proveedor, lineas, subtotal, flete, seguro, total, consignatario, condicion, incoterm, origen, puerto, peso, bultos, notas, entregado_por, convertida, factura_generada) values
  ...
  ('moe8hqzk9cmlm8i0fk', 'cate', 'O', 'Orden de Entrega', '2026-04-25', '00026', 'mo7ohq5472dfg5oihlu', 'USD', 'cate', '', '[{"prodId": "modnljottbsu06mrr7h", "nombre": "Aceite de Girazol NAZ (1 LT)", "codigo": "B-JAM-001-1037", "um": "KG", "qty": 1200, "price": 2.3, "importe": 2760}]'::jsonb, 2760, 0, 0, 2760, '', '', '', '', '', '', '', 'ALmacen de clavel', 'Nelson Pimentel', false, null),
