...
create index idx_mercancias_empresa on mercancias(empresa_id);
...
create index idx_invoices_empresa  on invoices(empresa_id);
create index idx_invoices_cliente  on invoices(cliente_id);
create index idx_invoices_tipo     on invoices(empresa_id, tipo_key);
...
create index idx_calculos_empresa on calculos(empresa_id);
...
create index idx_sync_log_pendiente on sync_log(synced, empresa_id);
